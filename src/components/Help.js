...
const Help = () => {
  return (
    <Jumbotron>
      <h3>About Rajkot Municipal Corporation (BMC)</h3>
      <span>
        Rajkot Municipal Corporation (BMC) is a local government committed to
        provide basic infrastructure facilities including entertainment
        facilities to the people of the city. BMC is very well known for the
